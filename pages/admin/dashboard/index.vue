    ...
    <div class="toolbar" id="kt_toolbar">
      ...
      <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="flex-wrap mb-5 page-title d-flex align-items-center me-3 mb-lg-0">
          <!--begin::Title-->
          <h1 class="my-1 d-flex align-items-center text-dark fw-bolder fs-3">Dashboard
          <!--begin::Separator-->
        ...
        <div class="gap-2 d-flex align-items-center gap-lg-3">
          ...
          <div class="m-0">
            ...
            <!--end::Menu toggle-->
            <!--begin::Menu 1-->
            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de0c0cad61e">
              <!--begin::Header-->
              <div class="py-5 px-7">
              ...
              <div class="py-5 px-7">
                ...
                <div class="mb-10">
                  ...
                  <!--begin::Input-->
                  <div>
                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61de0c0cad61e" data-allow-clear="true">
                      <option></option>
      ...
      <div id="kt_content_container" class="container-xxl">
        ...
        <div class="row gy-5 g-xl-8">
          ...
          <div class="col-xl-4">
            ...
            <div class="card card-xl-stretch">
              ...
              <div class="py-5 border-0 card-header bg-danger">
                <h3 class="text-white card-title fw-bolder">Sales Statistics</h3>
                <div class="card-toolbar">
                  <!--begin::Menu-->
                  <button type="button" class="border-0 btn btn-sm btn-icon btn-color-white btn-active-white btn-active-color- me-n3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
              ...
              <div class="p-0 card-body">
                ...
                <div class="card-p mt-n20 position-relative">
                  ...
                  <div class="row g-0">
                    <!--begin::Col-->
                    <div class="px-6 py-8 col bg-light-warning rounded-2 me-7 mb-7">
                    ...
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="px-6 py-8 col bg-light-primary rounded-2 mb-7">
                  ...
                  <div class="row g-0">
                    <!--begin::Col-->
                    <div class="px-6 py-8 col bg-light-danger rounded-2 me-7">
                      ...
                      <!--end::Svg Icon-->
                      <a href="#" class="mt-2 text-danger fw-bold fs-6">Item Orders</a>
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="px-6 py-8 col bg-light-success rounded-2">
                      ...
                      <!--end::Svg Icon-->
                      <a href="#" class="mt-2 text-success fw-bold fs-6">Bug Reports</a>
                    </div>
                    <!--end::Col-->
                  </div>
                  <!--end::Row-->
            ...
            <div class="card card-xl-stretch">
              ...
              <div class="mt-4 border-0 card-header align-items-center">
                <h3 class="card-title align-items-start flex-column">
                  <span class="mb-2 fw-bolder text-dark">Activities</span>
              ...
              <div class="pt-5 card-body">
                ...
                <div class="timeline-label">
                  ...
                  <div class="timeline-item">
                    <!--begin::Label-->
                    <div class="text-gray-800 timeline-label fw-bolder fs-6">08:42</div>
                    <!--end::Label-->
                    <!--begin::Badge-->
                  ...
                  <div class="timeline-item">
                    <!--begin::Label-->
                    <div class="text-gray-800 timeline-label fw-bolder fs-6">10:00</div>
                    <!--end::Label-->
                    <!--begin::Badge-->
                    <div class="timeline-badge">
                    ...
                    <div class="timeline-content d-flex">
                      <span class="text-gray-800 fw-bolder ps-3">AEOL meeting</span>
                    </div>
                    <!--end::Content-->
                  </div>
                  <!--end::Item-->
                  ...
                  <div class="timeline-item">
                    <!--begin::Label-->
                    <div class="text-gray-800 timeline-label fw-bolder fs-6">14:37</div>
                    <!--end::Label-->
                    <!--begin::Badge-->
                    <div class="timeline-badge">
                    ...
                    <!--end::Badge-->
                    <!--begin::Desc-->
                    <div class="text-gray-800 timeline-content fw-bolder ps-3">Make deposit
                  ...
                  <div class="timeline-item">
                    <!--begin::Label-->
                    <div class="text-gray-800 timeline-label fw-bolder fs-6">16:50</div>
                    <!--end::Label-->
                    <!--begin::Badge-->
                    <div class="timeline-badge">
                  ...
                  <div class="timeline-item">
                    <!--begin::Label-->
                    <div class="text-gray-800 timeline-label fw-bolder fs-6">21:03</div>
                    <!--end::Label-->
                    <!--begin::Badge-->
                    <div class="timeline-badge">
                      <i class="fa fa-genderless text-danger fs-1"></i>
                    ...
                    <!--end::Badge-->
                    <!--begin::Desc-->
                    <div class="text-gray-800 timeline-content fw-bold ps-3">New order placed
                  ...
                  <div class="timeline-item">
                    <!--begin::Label-->
                    <div class="text-gray-800 timeline-label fw-bolder fs-6">10:30</div>
                    <!--end::Label-->
                    <!--begin::Badge-->
                    <div class="timeline-badge">
                      <i class="fa fa-genderless text-success fs-1"></i>
          ...
          <div class="col-xl-4">
            ...
            <div class="mb-5 card card-xl-stretch-50 mb-xl-8">
              <!--begin::Body-->
              <div class="p-0 card-body d-flex flex-column">
                <!--begin::Stats-->
                <div class="pb-0 flex-grow-1 card-p">
            ...
            <div class="mb-5 card card-xl-stretch-50 mb-xl-8">
              <!--begin::Body-->
              <div class="p-0 overflow-hidden card-body d-flex justify-content-between flex-column">
                <!--begin::Hidden-->
                <div class="flex-wrap pb-3 d-flex flex-stack flex-grow-1 px-9 pt-9">
                  <div class="me-2">
                    <span class="text-gray-800 fw-bolder d-block fs-3">Sales</span>
          ...
          <div class="col-xl-8">
            ...
            <div class="mb-5 card card-xl-stretch mb-xl-8">
              ...
              <div class="pt-5 border-0 card-header">
                <h3 class="card-title align-items-start flex-column">
                  <span class="mb-1 card-label fw-bolder fs-3">Members Statistics</span>
                  <span class="mt-1 text-muted fw-bold fs-7">Over 500 members</span>
                </h3>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-start flex-column">
                              ...
                              <span class="text-muted fw-bold d-block fs-7">HTML, JS, ReactJS</span>
                            </div>
                          </div>
                        </td>
                        <td>
                          <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">Intertico</a>
                          <span class="text-muted fw-bold d-block fs-7">Web, UI/UX Design</span>
                        </td>
                        <td class="text-end">
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-start flex-column">
                              ...
                              <span class="text-muted fw-bold d-block fs-7">C#, ASP.NET, MS SQL</span>
                            </div>
                          </div>
                        </td>
                        <td>
                          <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">Agoda</a>
                          <span class="text-muted fw-bold d-block fs-7">Houses &amp; Hotels</span>
                        </td>
                        <td class="text-end">
                          <div class="d-flex flex-column w-100 me-2">
                            <div class="mb-2 d-flex flex-stack">
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-start flex-column">
                              ...
                              <span class="text-muted fw-bold d-block fs-7">PHP, Laravel, VueJS</span>
                            </div>
                          </div>
                        </td>
                        <td>
                          <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">RoadGee</a>
                          <span class="text-muted fw-bold d-block fs-7">Transportation</span>
                        </td>
                        <td class="text-end">
                          <div class="d-flex flex-column w-100 me-2">
                            <div class="mb-2 d-flex flex-stack">
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex justify-content-start flex-column">
                              ...
                              <span class="text-muted fw-bold d-block fs-7">Python, PostgreSQL, ReactJS</span>
                            </div>
                          </div>
                        </td>
                        <td>
                          <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6">The Hill</a>
                          <span class="text-muted fw-bold d-block fs-7">Insurance</span>
                        </td>
                        <td class="text-end">
                          <div class="d-flex flex-column w-100 me-2">
                            <div class="mb-2 d-flex flex-stack">
            ...
            <div class="card card-xl-stretch mb-xl-8">
              ...
              <div class="pt-2 card-body">
                ...
                <div class="d-flex align-items-center mb-7">
                  <!--begin::Avatar-->
                  <div class="symbol symbol-50px me-5">
                    <img src="/media/avatars/300-5.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center mb-7">
                  <!--begin::Avatar-->
                  <div class="symbol symbol-50px me-5">
                    <img src="/media/avatars/300-11.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center mb-7">
                  <!--begin::Avatar-->
                  <div class="symbol symbol-50px me-5">
                    <img src="/media/avatars/300-9.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center">
                  <!--begin::Avatar-->
                  <div class="symbol symbol-50px me-5">
                    <img src="/media/avatars/300-23.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
              ...
              <div class="pt-0 card-body">
                ...
                <div class="p-5 rounded d-flex align-items-center bg-light-warning mb-7">
                  ...
                  <div class="flex-grow-1 me-2">
                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Group lunch celebration</a>
                    <span class="text-muted fw-bold d-block">Due in 2 Days</span>
                  </div>
                  <!--end::Title-->
                  <!--begin::Lable-->
                  <span class="py-1 fw-bolder text-warning">+28%</span>
                  <!--end::Lable-->
                </div>
                <!--end::Item-->
                <!--begin::Item-->
                <div class="p-5 rounded d-flex align-items-center bg-light-success mb-7">
                  ...
                  <!--begin::Title-->
                  <div class="flex-grow-1 me-2">
                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Navigation optimization</a>
                    <span class="text-muted fw-bold d-block">Due in 2 Days</span>
                  </div>
                  <!--end::Title-->
                  <!--begin::Lable-->
                  <span class="py-1 fw-bolder text-success">+50%</span>
                  <!--end::Lable-->
                </div>
                <!--end::Item-->
                <!--begin::Item-->
                <div class="p-5 rounded d-flex align-items-center bg-light-danger mb-7">
                  ...
                  <!--begin::Title-->
                  <div class="flex-grow-1 me-2">
                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Rebrand strategy planning</a>
                    <span class="text-muted fw-bold d-block">Due in 5 Days</span>
                  </div>
                  <!--end::Title-->
                  <!--begin::Lable-->
                  <span class="py-1 fw-bolder text-danger">-27%</span>
                  <!--end::Lable-->
                </div>
                <!--end::Item-->
                <!--begin::Item-->
                <div class="p-5 rounded d-flex align-items-center bg-light-info">
                  ...
                  <!--begin::Title-->
                  <div class="flex-grow-1 me-2">
                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Product goals strategy</a>
                    <span class="text-muted fw-bold d-block">Due in 7 Days</span>
                  </div>
                  <!--end::Title-->
                  <!--begin::Lable-->
                  <span class="py-1 fw-bolder text-info">+8%</span>
                  <!--end::Lable-->
                </div>
                <!--end::Item-->
              </div>
            ...
            <div class="mb-5 card card-xl-stretch mb-xl-8">
              ...
              <div class="pt-5 border-0 card-header">
                <h3 class="card-title align-items-start flex-column">
                  ...
                  <span class="mt-1 text-muted fw-bold fs-7">Latest tech trends</span>
                </h3>
                <div class="card-toolbar">
                  <!--begin::Menu-->
                  <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
              ...
              <div class="pt-5 card-body">
                ...
                <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="flex-wrap d-flex align-items-center flex-row-fluid">
                    ...
                    <span class="my-2 badge badge-light fw-bolder">+82$</span>
                  </div>
                  <!--end::Section-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="flex-wrap d-flex align-items-center flex-row-fluid">
                    ...
                    <span class="my-2 badge badge-light fw-bolder">+280$</span>
                  </div>
                  <!--end::Section-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="flex-wrap d-flex align-items-center flex-row-fluid">
                    ...
                    <span class="my-2 badge badge-light fw-bolder">+4500$</span>
                  </div>
                  <!--end::Section-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="flex-wrap d-flex align-items-center flex-row-fluid">
                    ...
                    <span class="my-2 badge badge-light fw-bolder">+686$</span>
                  </div>
                  <!--end::Section-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="flex-wrap d-flex align-items-center flex-row-fluid">
                    ...
                    <span class="my-2 badge badge-light fw-bolder">+726$</span>
                  </div>
                  <!--end::Section-->
                </div>
                <!--end::Item-->
        ...
        <div class="row g-5 g-xl-8">
          ...
          <div class="col-xl-4">
            ...
            <div class="card card-xxl-stretch mb-xl-8">
              ...
              <div class="py-5 border-0 card-header">
                <h3 class="card-title align-items-start flex-column">
                  <span class="mb-1 card-label fw-bolder fs-3">Trends</span>
          ...
          <div class="col-xl-8">
            ...
            <div class="mb-5 card card-xxl-stretch mb-xl-8">
              ...
              <div class="pt-5 border-0 card-header">
                <h3 class="card-title align-items-start flex-column">
                  <span class="mb-1 card-label fw-bolder fs-3">Latest Products</span>
                  <span class="mt-1 text-muted fw-bold fs-7">More than 400 new products</span>
                </h3>
                <div class="card-toolbar">
                  <ul class="nav">
                    <li class="nav-item">
                      <a class="px-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bolder me-1 active" data-bs-toggle="tab" href="#kt_table_widget_5_tab_1">Month</a>
                    </li>
                    <li class="nav-item">
                      <a class="px-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bolder me-1" data-bs-toggle="tab" href="#kt_table_widget_5_tab_2">Week</a>
                    </li>
                    <li class="nav-item">
                      <a class="px-4 nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bolder" data-bs-toggle="tab" href="#kt_table_widget_5_tab_3">Day</a>
                    </li>
                  </ul>
                </div>
              </div>
                      ...
                      <table class="table align-middle table-row-dashed table-row-gray-200 gs-0 gy-4">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <a href="#" class="mb-1 text-dark fw-bolder text-hover-primary fs-6">Brad Simmons</a>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="#" class="mb-1 text-dark fw-bolder text-hover-primary fs-6">Popular Authors</a>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="#" class="mb-1 text-dark fw-bolder text-hover-primary fs-6">New Users</a>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="#" class="mb-1 text-dark fw-bolder text-hover-primary fs-6">Active Customers</a>
                              <span class="text-muted fw-bold d-block">Movie Creator</span>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="#" class="mb-1 text-dark fw-bolder text-hover-primary fs-6">Bestseller Theme</a>
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
              ...
              <span class="mt-1 text-muted fw-bold fs-7">Preview monthly events</span>
            </h3>
            <div class="card-toolbar">
              ...
              <form class="form" action="#" id="kt_modal_add_event_form">
                ...
                <div class="py-10 modal-body px-lg-17">
                  ...
                  <div class="fv-row mb-9">
                    <!--begin::Label-->
                    <label class="mb-2 fs-6 fw-bold required">Event Name</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                  ...
                  <div class="fv-row mb-9">
                    <!--begin::Label-->
                    <label class="mb-2 fs-6 fw-bold">Event Description</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                  ...
                  <div class="fv-row mb-9">
                    <!--begin::Label-->
                    <label class="mb-2 fs-6 fw-bold">Event Location</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                  ...
                  <div class="row row-cols-lg-2 g-10">
                    <div class="col">
                      <div class="fv-row mb-9">
                        <!--begin::Label-->
                        <label class="mb-2 fs-6 fw-bold required">Event Start Date</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                    ...
                    <div class="col" data-kt-calendar="datepicker">
                      <div class="fv-row mb-9">
                        <!--begin::Label-->
                        <label class="mb-2 fs-6 fw-bold">Event Start Time</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                  ...
                  <div class="row row-cols-lg-2 g-10">
                    <div class="col">
                      <div class="fv-row mb-9">
                        <!--begin::Label-->
                        <label class="mb-2 fs-6 fw-bold required">Event End Date</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                    ...
                    <div class="col" data-kt-calendar="datepicker">
                      <div class="fv-row mb-9">
                        <!--begin::Label-->
                        <label class="mb-2 fs-6 fw-bold">Event End Time</label>
                        <!--end::Label-->
                        <!--begin::Input-->
        ...
        <div class="modal fade" id="kt_modal_view_event" tabindex="-1" aria-hidden="true">
          ...
          <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
              ...
              <!--end::Modal header-->
              <!--begin::Modal body-->
              <div class="pt-0 pb-20 modal-body px-lg-17">
                <!--begin::Row-->
                <div class="d-flex">
                  <!--begin::Icon-->
